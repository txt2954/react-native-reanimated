...
var require_types = __commonJS({
  'lib/types.js'(exports2) {
    ...
    exports2.isWorkletizableObjectType =
      exports2.isWorkletizableFunctionType =
      exports2.WorkletizableObject =
      exports2.WorkletizableFunction =
        void 0;
    exports2.WorkletizableFunction =
...
var require_globals = __commonJS({
  'lib/globals.js'(exports2) {
    'use strict';
    Object.defineProperty(exports2, '__esModule', { value: true });
    exports2.initializeGlobals =
      exports2.globals =
      exports2.defaultGlobals =
        void 0;
    ...
    exports2.defaultGlobals = new Set(
...
var require_utils = __commonJS({
  'lib/utils.js'(exports2) {
    ...
    function isRelease() {
      ...
      return !!(
        ((_a = process.env.BABEL_ENV) === null || _a === void 0
          ? void 0
          : _a.match(pattern)) ||
        ((_b = process.env.NODE_ENV) === null || _b === void 0
          ? void 0
          : _b.match(pattern))
      );
    }
  ...
  'lib/workletStringCode.js'(exports2) {
    ...
    function buildWorkletString(fun, closureVariables, name, inputMap) {
      const draftExpression =
        fun.program.body.find((obj) =>
          (0, types_12.isFunctionDeclaration)(obj)
        ) ||
        fun.program.body.find((obj) =>
          (0, types_12.isExpressionStatement)(obj)
        ) ||
        void 0;
      (0, assert_1.strict)(
        draftExpression,
        '[Reanimated] `draftExpression` is undefined.'
      );
      const expression = (0, types_12.isFunctionDeclaration)(draftExpression)
        ? draftExpression
      ...
      (0, assert_1.strict)(
        (0, types_12.isBlockStatement)(expression.body),
      ...
      (0, core_1.traverse)(fun, {
        NewExpression(path) {
          ...
          closureVariables.push(
            (0, types_12.identifier)(constructorName + 'ClassFactory')
          );
          expression.body.body.unshift(
            (0, types_12.variableDeclaration)('const', [
              (0, types_12.variableDeclarator)(
                (0, types_12.identifier)(constructorName),
                (0, types_12.callExpression)(
                  (0, types_12.identifier)(constructorName + 'ClassFactory'),
                  []
                )
              ),
      ...
      const workletFunction = (0, types_12.functionExpression)(
        (0, types_12.identifier)(name),
        expression.params,
        expression.body,
    ...
    function prependClosure(path, closureVariables, closureDeclaration) {
      if (
        ...
        !(0, types_12.isProgram)(path.parent)
      ) {
        return;
      }
    ...
    function prependRecursiveDeclaration(path) {
      ...
      if (
        (0, types_12.isProgram)(path.parent) &&
        !(0, types_12.isArrowFunctionExpression)(path.node) &&
        !(0, types_12.isObjectMethod)(path.node) &&
        path.node.id &&
        path.scope.parent
      ) {
        ...
        if (hasRecursiveCalls) {
          path.node.body.body.unshift(
            (0, types_12.variableDeclaration)('const', [
              (0, types_12.variableDeclarator)(
                (0, types_12.identifier)(path.node.id.name),
                (0, types_12.memberExpression)(
                  (0, types_12.thisExpression)(),
                  (0, types_12.identifier)('_recur')
                )
              ),
            ])
          );
    ...
    function prependClosureVariablesIfNecessary(closureVariables) {
      const closureDeclaration = (0, types_12.variableDeclaration)('const', [
        (0, types_12.variableDeclarator)(
          (0, types_12.objectPattern)(
            closureVariables.map((variable) =>
              (0, types_12.objectProperty)(
                (0, types_12.identifier)(variable.name),
                (0, types_12.identifier)(variable.name),
                false,
                true
              )
...
var require_workletFactory = __commonJS({
  'lib/workletFactory.js'(exports2) {
    ...
    function makeWorkletFactory(fun, state) {
      ...
      (0, assert_1.strict)(
        transformed,
        '[Reanimated] `transformed` is undefined.'
      );
      (0, assert_1.strict)(
        transformed.ast,
        '[Reanimated] `transformed.ast` is undefined.'
      );
      ...
      const funExpression = (0, types_12.isBlockStatement)(clone.body)
        ? (0, types_12.functionExpression)(
            null,
            clone.params,
            clone.body,
            clone.generator,
        ...
        : clone;
      let [funString, sourceMapString] = (0,
      workletStringCode_1.buildWorkletString)(
        transformed.ast,
        variables,
        functionName,
        transformed.map
      ...
      const pathForStringDefinitions = fun.parentPath.isProgram()
        ...
        : fun.findParent((path) => {
            var _a, _b;
            return (_b =
              (_a = path.parentPath) === null || _a === void 0
                ? void 0
                : _a.isProgram()) !== null && _b !== void 0
              ? _b
              : false;
          });
      (0, assert_1.strict)(
      ...
      const initDataObjectExpression = (0, types_12.objectExpression)([
        (0, types_12.objectProperty)(
          (0, types_12.identifier)('code'),
          (0, types_12.stringLiteral)(funString)
        ),
      ]);
      ...
      if (shouldInjectLocation) {
        ...
        if (state.opts.relativeSourceLocation) {
          ...
          sourceMapString =
            sourceMapString === null || sourceMapString === void 0
              ? void 0
              : sourceMapString.replace(state.file.opts.filename, location);
        }
        initDataObjectExpression.properties.push(
          (0, types_12.objectProperty)(
            (0, types_12.identifier)('location'),
            (0, types_12.stringLiteral)(location)
          )
        );
      }
      if (sourceMapString) {
        initDataObjectExpression.properties.push(
          (0, types_12.objectProperty)(
            (0, types_12.identifier)('sourceMap'),
            (0, types_12.stringLiteral)(sourceMapString)
          )
        );
      }
      ...
      if (shouldInjectVersion) {
        initDataObjectExpression.properties.push(
          (0, types_12.objectProperty)(
            (0, types_12.identifier)('version'),
            (0, types_12.stringLiteral)(
              shouldMockVersion() ? MOCK_VERSION : REAL_VERSION
            )
          )
        );
      }
      ...
      (0, assert_1.strict)(
        !(0, types_12.isFunctionDeclaration)(funExpression),
        '[Reanimated] `funExpression` is a `FunctionDeclaration`.'
      );
      (0, assert_1.strict)(
        !(0, types_12.isObjectMethod)(funExpression),
      ...
      const statements = [
        ...
        (0, types_12.expressionStatement)(
          (0, types_12.assignmentExpression)(
            ...
            (0, types_12.objectExpression)(
              variables.map((variable) =>
                variable.name.endsWith('ClassFactory')
                  ? (0, types_12.objectProperty)(
                      (0, types_12.identifier)(variable.name),
                      (0, types_12.memberExpression)(
                        (0, types_12.identifier)(
                          variable.name.slice(0, 'ClassFactory'.length)
                        ),
                        (0, types_12.identifier)(variable.name)
                      )
                    )
        ...
        (0, types_12.expressionStatement)(
          (0, types_12.assignmentExpression)(
            ...
            (0, types_12.memberExpression)(
              functionIdentifier,
              (0, types_12.identifier)('__workletHash'),
              false
            ),
        ...
        statements.push(
          (0, types_12.expressionStatement)(
            (0, types_12.assignmentExpression)(
              ...
              (0, types_12.memberExpression)(
                functionIdentifier,
                (0, types_12.identifier)('__initData'),
                false
              ),
              initDataId
            )
      ...
      const newFun = (0, types_12.functionExpression)(
        void 0,
        [],
        (0, types_12.blockStatement)(statements)
      );
      return newFun;
    }
    ...
    function makeWorkletName(fun) {
      if (
        (0, types_12.isObjectMethod)(fun.node) &&
        (0, types_12.isIdentifier)(fun.node.key)
      ) {
        return fun.node.key.name;
      }
      if (
        (0, types_12.isFunctionDeclaration)(fun.node) &&
        (0, types_12.isIdentifier)(fun.node.id)
      ) {
        return fun.node.id.name;
      }
      if (
        (0, types_12.isFunctionExpression)(fun.node) &&
        (0, types_12.isIdentifier)(fun.node.id)
      ) {
        return fun.node.id.name;
      }
    ...
    function makeArrayFromCapturedBindings(ast, fun) {
      ...
      (0, core_1.traverse)(ast, {
        Identifier(path) {
          ...
          if (
            (0, types_12.isMemberExpression)(parentNode) &&
          ...
          if (
            (0, types_12.isObjectProperty)(parentNode) &&
            (0, types_12.isObjectExpression)(path.parentPath.parent) &&
...
var require_workletFactoryCall = __commonJS({
  'lib/workletFactoryCall.js'(exports2) {
    ...
    function makeWorkletFactoryCall(path, state) {
      const workletFactory = (0, workletFactory_1.makeWorkletFactory)(
        path,
        state
      );
      const workletFactoryCall = (0, types_12.callExpression)(
        workletFactory,
        []
      );
...
var require_workletSubstitution = __commonJS({
  'lib/workletSubstitution.js'(exports2) {
    'use strict';
    Object.defineProperty(exports2, '__esModule', { value: true });
    exports2.maybeSubstituteFunctionDeclarationWithVariableDeclaration =
      exports2.substituteObjectMethodWithObjectProperty =
      exports2.processWorklet =
      exports2.processIfWithWorkletDirective =
        void 0;
    var types_12 = require('@babel/types');
    ...
    function hasWorkletDirective(directives) {
      return directives.some(
        (directive) =>
          (0, types_12.isDirectiveLiteral)(directive.value) &&
    ...
    function substituteObjectMethodWithObjectProperty(
      path,
      workletFactoryCall
    ) {
      const replacement = (0, types_12.objectProperty)(
        path.node.key,
        workletFactoryCall
      );
    ...
    exports2.substituteObjectMethodWithObjectProperty =
      substituteObjectMethodWithObjectProperty;
    function maybeSubstituteFunctionDeclarationWithVariableDeclaration(
      path,
      workletFactoryCall
    ) {
      const needDeclaration =
        (0, types_12.isScopable)(path.parent) ||
        (0, types_12.isExportNamedDeclaration)(path.parent);
      const replacement =
...
var require_gestureHandlerAutoworkletization = __commonJS({
  'lib/gestureHandlerAutoworkletization.js'(exports2) {
    ...
    function isGestureHandlerEventCallback(path) {
      return (
        (0, types_12.isCallExpression)(path.parent) &&
        (0, types_12.isExpression)(path.parent.callee) &&
    ...
    function isGestureObjectEventCallbackMethod(exp) {
      return (
        (0, types_12.isMemberExpression)(exp) &&
        (0, types_12.isIdentifier)(exp.property) &&
    ...
    function containsGestureObject(exp) {
      ...
      if (
        (0, types_12.isCallExpression)(exp) &&
        (0, types_12.isMemberExpression)(exp.callee) &&
    ...
    function isGestureObject(exp) {
      return (
        (0, types_12.isCallExpression)(exp) &&
        (0, types_12.isMemberExpression)(exp.callee) &&
        (0, types_12.isIdentifier)(exp.callee.object) &&
        exp.callee.object.name === 'Gesture' &&
        (0, types_12.isIdentifier)(exp.callee.property) &&
  ...
  'lib/layoutAnimationAutoworkletization.js'(exports2) {
    ...
    function isLayoutAnimationsChainableOrNewOperator(exp) {
      if ((0, types_12.isIdentifier)(exp) && LayoutAnimations.has(exp.name)) {
        ...
        (0, types_12.isNewExpression)(exp) &&
        (0, types_12.isIdentifier)(exp.callee) &&
...
var require_referencedWorklets = __commonJS({
  'lib/referencedWorklets.js'(exports2) {
    ...
    function findReferencedWorklet(
      workletIdentifier,
    ...
    function findReferencedWorkletFromVariableDeclarator(
      ...
      if (
        acceptWorkletizableFunction &&
        (0, types_12.isWorkletizableFunctionType)(worklet)
      ) {
        return worklet;
      }
    ...
    function findReferencedWorkletFromAssignmentExpression(
      ...
      const workletDeclaration = workletBinding.constantViolations
        ...
        .find(
          (constantViolation) =>
            ...
            ((acceptWorkletizableFunction &&
              (0, types_12.isWorkletizableFunctionType)(
                constantViolation.get('right')
              )) ||
              (acceptObject &&
                (0, types_12.isWorkletizableObjectType)(
                  constantViolation.get('right')
                )))
        );
      ...
      if (
        acceptWorkletizableFunction &&
        (0, types_12.isWorkletizableFunctionType)(workletDefinition)
      ) {
        return workletDefinition;
      }
      if (
        acceptObject &&
        (0, types_12.isWorkletizableObjectType)(workletDefinition)
      ) {
        return workletDefinition;
      }
      return void 0;
...
var require_autoworkletization = __commonJS({
  'lib/autoworkletization.js'(exports2) {
    ...
    var types_2 = require_types();
    var workletSubstitution_12 = require_workletSubstitution();
    var gestureHandlerAutoworkletization_1 =
      require_gestureHandlerAutoworkletization();
    var layoutAnimationAutoworkletization_1 =
      require_layoutAnimationAutoworkletization();
    ...
    function processIfAutoworkletizableCallback(path, state) {
      if (
        (0, gestureHandlerAutoworkletization_1.isGestureHandlerEventCallback)(
          path
        ) ||
        (0, layoutAnimationAutoworkletization_1.isLayoutAnimationCallback)(path)
      ) {
    ...
    exports2.processIfAutoworkletizableCallback =
      processIfAutoworkletizableCallback;
    function processCalleesAutoworkletizableCallbacks(path, state) {
      const callee = (0, types_12.isSequenceExpression)(path.node.callee)
    ...
    function findWorklet(arg, acceptWorkletizableFunction, acceptObject) {
      if (
        acceptWorkletizableFunction &&
        (0, types_2.isWorkletizableFunctionType)(arg)
      ) {
        return arg;
      }
      ...
      if (arg.isReferencedIdentifier() && arg.isIdentifier()) {
        return (0, referencedWorklets_1.findReferencedWorklet)(
          arg,
          acceptWorkletizableFunction,
          acceptObject
        );
...
var require_inlineStylesWarning = __commonJS({
  'lib/inlineStylesWarning.js'(exports2) {
    ...
    function generateInlineStylesWarning(path) {
      return (0, types_12.callExpression)(
        (0, types_12.arrowFunctionExpression)(
          [],
          (0, types_12.blockStatement)([
            (0, types_12.expressionStatement)(
              (0, types_12.callExpression)(
                (0, types_12.memberExpression)(
                  (0, types_12.identifier)('console'),
                  (0, types_12.identifier)('warn')
                ),
                [
                  (0, types_12.callExpression)(
                    (0, types_12.memberExpression)(
                      (0, types_12.callExpression)(
                        (0, types_12.identifier)('require'),
    ...
    function processStyleObjectForInlineStylesWarning(path) {
      ...
      for (const property of properties) {
        if (property.isObjectProperty()) {
          const value = property.get('value');
          if (
            (0, types_12.isIdentifier)(property.node.key) &&
...
var require_class = __commonJS({
  'lib/class.js'(exports2) {
    ...
    function processClass(path, state) {
      ...
      (0, traverse_1.default)(ast, {
        [types_2.WorkletizableFunction]: {
          enter: (functionPath) => {
            ...
            const workletDirective = (0, types_12.directive)(
              (0, types_12.directiveLiteral)('worklet')
            );
            if (
              functionPath.parentPath.isCallExpression() &&
              !hasHandledClass
            ) {
              const factoryCopy = (0, types_12.cloneNode)(
                functionPath.node,
                true
              );
              factoryCopy.id = (0, types_12.identifier)(
                className + 'ClassFactory'
              );
              factoryCopy.body.directives.push(workletDirective);
              factory = (0, types_12.variableDeclaration)('const', [
                (0, types_12.variableDeclarator)(
                  (0, types_12.identifier)(className + 'ClassFactory'),
                  factoryCopy
                ),
              ]);
            ...
            if (!bodyPath.isBlockStatement()) {
              bodyPath.replaceWith(
                (0, types_12.blockStatement)([
                  (0, types_12.returnStatement)(bodyPath.node),
                ])
              );
            }
      ...
      body.push(
        (0, types_12.expressionStatement)(
          (0, types_12.assignmentExpression)(
            '=',
            (0, types_12.memberExpression)(
              (0, types_12.identifier)(className),
              (0, types_12.identifier)(className + 'ClassFactory')
            ),
            (0, types_12.identifier)(className + 'ClassFactory')
          )
      ...
      const transformedNewCode = (0, core_1.transformSync)(
        (0, generator_1.default)(ast).code,
        {
          ast: true,
          filename: state.file.opts.filename,
        }
...
var require_file = __commonJS({
  'lib/file.js'(exports2) {
    ...
    function processWorkletFile(path, state) {
      ...
      path.traverse({
        ClassDeclaration(subPath) {
          (0, class_1.processClass)(subPath, state);
        },
      });
    }
...
var require_contextObject = __commonJS({
  'lib/contextObject.js'(exports2) {
    ...
    function processIfWorkletContextObject(path, state) {
      ...
      path.traverse({
        ObjectProperty(subPath) {
          if (
            (0, types_12.isIdentifier)(subPath.node.key) &&
    ...
    function processWorkletContextObject(path, _state) {
      ...
      const workletObjectFactory = (0, types_12.functionExpression)(
        null,
        [],
        (0, types_12.blockStatement)(
          [(0, types_12.returnStatement)((0, types_12.cloneNode)(path.node))],
          [(0, types_12.directive)((0, types_12.directiveLiteral)('worklet'))]
        )
      );
      path.node.properties.push(
        (0, types_12.objectProperty)(
          (0, types_12.identifier)('__workletObjectFactory'),
  ...
  return {
    ...
    visitor: {
      CallExpression: {
        enter(path, state) {
          runWithTaggedExceptions(() => {
            (0, autoworkletization_1.processCalleesAutoworkletizableCallbacks)(
              path,
              state
            );
      ...
      [types_1.WorkletizableFunction]: {
        enter(path, state) {
          runWithTaggedExceptions(() => {
            (0, workletSubstitution_1.processIfWithWorkletDirective)(
              path,
              state
            ) ||
              (0, autoworkletization_1.processIfAutoworkletizableCallback)(
                path,
                state
              );
          });
      ...
      JSXAttribute: {
        enter(path, state) {
          runWithTaggedExceptions(() =>
            (0, inlineStylesWarning_1.processInlineStylesWarning)(path, state)
          );
        },
      },
    },
